        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-book"></i>&nbsp;Manajemen Data Indikator Kepuasan Untuk Dosen dan Tendik</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <form action="{{ route('operator.indikator.post.dosen_tendik') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @if ($indikator->ditampilkan == 1)
                                                                <form
                                                                    action="{{ route('operator.indikator.aktif.dosen_tendik', [$indikator->id]) }}"
                                                                    method="POST">
                                                            ...
                                                            @else
                                                                <form
                                                                    action="{{ route('operator.indikator.nonaktif.dosen_tendik', [$indikator->id]) }}"
                                                                    method="POST">
                                                                    {{ csrf_field() }} {{ method_field('DELETE') }}
                                                                    <button type="submit"
