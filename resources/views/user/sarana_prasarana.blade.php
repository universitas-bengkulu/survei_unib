            ...
            <div
                ...
                @else
                    <div
                        ...
                        <form action="{{ route('saranaprasarana.post') }}" method="post">
                            @csrf
                            ...
                            <div
                                ...
                                <div class="mt-6 px-6 py-4   w-full">
                                    <div class="  -mt-6 lg:px-6      grid grid-cols-1  ">
                                        <div class="mb-3">
                                            <label for="pekerjaan"
                                                class=" after:content-['*'] after:text-red-500 font-semibold  text-white  after:ml-2 text-sm pb-1">Pengguna Sarana dan Prasarana</label>
                                            <select name="pekerjaan"
                                                ...
                                                <option disabled selected>-- pilih Pengguna Layanan--</option>
                                ...
                                <div class="  lg:px-6 py-4 -mt-5  ">
                                    <div class="  -mt-6 px-6 ">
                                        ...
                                        <ul class=" list-disc    ml-10 text-left   text-sm ">
                                            <li><strong>Sangat Puas</strong> = Nilai 5</li>
                                            <li><strong>Puas</strong> = Nilai 4</li>
                                            <li><strong>Cukup</strong> = Nilai 3</li>
                                            <li><strong>Tidak Puas</strong> = Nilai 2</li>
                                            <li><strong>Sangat Tidak Puas</strong> = Nilai 1</li>
                                        </ul>
                            ...
                            <div
                                ...
                                <div>
                                    <div
                                        ...
                                        Survei Kepuasan Pengguna untuk Sarana Dan Prasarana  Universitas Bengkulu Tahun
                                        <script>
                                            document.write(new Date().getFullYear())
                                        </script>
                                    </div>
                                    ...
                                    <div class="  -mt-6 px-6 ">
                                        ...
                                        <div class=" md:mx-4 lg:mx-6 py-6">
                                            <label for="comment"
                                                ...
                                                Pesan dan Saran Anda Untuk Sarana Dan Prasarana  Universitas
                                                Bengkulu
