...
class IndikatorSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('indikators')->insert([
            ...
            ['nama_indikator' => 'Fasilitas dan pelayanan untuk memperoleh beasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Layanan pengembangan minat dan bakat yang digunakan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Layanan bimbingan dan konseling untuk mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kategori layanan sarana dan prasarana berupa fasilitas dan pelayanan memperoleh beasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Layanan informasi pembinaan karier mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Layanan dan informasi lowongan pekerjaan bagi calon lulusan', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Keadaan ruang perkuliahan/kelas yang digunakan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kepuasan layanan kesehatan mahasiswa ', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Keadaan ruang laboratorium dan peralatan yang menunjang proses belajar mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Layanan koleksi dan kemudahan akses perpustakaan untuk memperoleh sumber belajar mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Fasilitas ibadah yang tersedia untuk digunakan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Fasilitas olahraga yang digunakan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Fasilitas kantin yang digunakan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Fasilitas klinik yang digunakan mahasiswa ', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Fasilitas toilet yang digunakan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Fasilitas internet yang dimanfaatkan untuk kegiatan mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kepuasan terhadap fasilitas organisasi kemahasiswaan', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Ketersediaan informasi akademik (website, media sosial, dan poster )', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kepuasan mahasiswa terhadap kebersihan kelas/kampus', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kepuasan Mahasiswa terhadap keamanan kampus', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kepuasan mahasiswa terhadap layanan bidang akademik ', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kurikulum pendidikan yang diterima ', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kejelasan rencana pembelajaran/kontrak perkuliahan ', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Pelaksanaan proses belajar mengajar yang diterima mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Sistem penilaian dan evaluasi (UAS/UTS/Tugas terstruktur) yang diberikan ke mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kebaruan materi perkuliahan yang digunakan dosen dari sumber belajar yang up to date', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Pengembangan kemampuan mahasiswa yang mendukung Keterampilan Abad 21', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Suasana akademik yang mendukung pengembangan kompetensi mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Kompetensi Dosen yang mengajar atau membimbing mahasiswa', 'ditampilkan' => 1, 'category_id' => 4],
            ['nama_indikator' => 'Pengembangan soft skill mahasiswa melalui berbagai kegiatan ekstrakurikuler dan intrakurikuler', 'ditampilkan' => 1, 'category_id' => 4],
